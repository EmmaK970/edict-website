const projects = [
    ...
    },
    {
        ...
        secondments: ["Host: University of Aberdeen, UK", "Planned Secondments*: ECRIN, France (M12-16) and WCN (Dutch Cardiovascular Research Network) (M22-26).", "*Please note that the secondment placements outlined below are planned in collaboration with industry partners and may be subject to change over the course of the project"],
