const projects = [
    {
        ...
        secondments: ["Host: Catholic University of Croatia", "Planned Secondments*: Medtronic, UK (M12-16) and University of Split School of Medicine (M22-26).", "Please note that the secondment placements are planned in collaboration with industry partners and may be subject to change over the course of the project"],
    ...
    },
    {
        ...
        secondments: ["Host: University of Aberdeen, UK", "Planned Secondments*: ECRIN, France (M12-16) and WCN (Dutch Cardiovascular Research Network) (M22-26).", "Please note that the secondment placements are planned in collaboration with industry partners and may be subject to change over the course of the project"],
    ...
    },
    {
        ...
        secondments: ["Host: University of Basel, Switzerland", "Planned Secondments*: HRB-TMRN at the University of Galway (M12-16) and Campbell-Cochrane Equity, Canada (M22-26)."],
        degree: "Master's in health sciences, social sciences, psychology, public health, or related field.",
    ...
    },
    {
        ...
        secondments: ["Host: Université Paris Cité, France", "Planned Secondments*: HRB-TMRN and the School of Mathematical and Statistical Sciences at University of Galway (M12-16) and Department of Epidemiology & Global Health at UMC Utrecht (M22-26)."],
    ...
    },
    {
        ...
        secondments: ["Host: University of Galway, Ireland", "Planned Secondments*: Pfizer, USA (M12-16) and Patient Focused Medicines Development (PFMD), Belgium (M22-26)."],
    ...
    },
    {
        ...
        secondments: ["Host: La Paz University Hospital, Spain", "Planned Secondments*: Sense About Science, UK (M12-16) and Julius Clinical, Netherlands (M22-26)."],
    ...
    },
    {
        ...
        secondments: ["Host: La Paz University Hospital, Spain (FIBHULP)", "Planned Secondments*: Medtronic, UK (M12-16) and Aarhus University's Department of Public Health, Denmark(M22-26)."],
    ...
    },
    {
        ...
        secondments: ["Host: UMC Utrecht, Netherlands", "Planned Secondments*: Julius Clinical, Netherlands (M12-16) and Paris UP Cité, France(M22-26)."],
    ...
    },
    {
        ...
        secondments: ["Host: UMC Utrecht, Netherlands", "Planned Secondments*: WCN (Dutch Cardiovascular Trials Network), Netherlands (M12-16) and Julius Clinical, Netherlands(M22-26)."],
    ...
    },
    {
        ...
        secondments: ["Host: UMC Utrecht, Netherlands", "Planned Secondments*: Centre for Implementation Research, University of Ottawa, Canada (M12-16) and Medicines Evaluation Board, Netherlands(M22-26"],
    ...
    },
    {
        ...
        secondments: ["Host: University of Galway, Ireland", "Planned Secondments*: Medtronic, UK (M12-16) and PFMD (Patient Focused Medicines Development), Belgium (M22-26)."],
    ...
    },
    {
        ...
        secondments: ["Host: University of Galway, Ireland", "Planned Secondments*: Sense About Science, UK (M12-16) and Campbell-Cochrane Equity, Canada(M22-26)."],
    ...
    },
    {
        ...
        secondments: ["Host: University of Basel, Switzerland", "Planned Secondments*: UMC Utrecht, Netherlands (M12-16) and Roche, Switzerland(M22-26)."],
        degree: "Master's in health sciences, social sciences, psychology, public health, education, implementation science, or related field.",
        academic: "Completed Master's degree with excellent grades.",
        mobility: "Must not have resided in Switzerland for more than 12 months in the 36 months prior to recruitment."
    },
    {
        ...
        secondments: ["Host: Catholic University of Croatia", "Planned Secondments*: ECRIN, France (M12-16) and University of Split School of Medicine, Croatia (M22-26)."],
        degree: "Master's in health sciences, social sciences, psychology, public health, education, implementation science, or related field.",
        academic: "At least 2.1 honours degree with strong Master's grades.",
        mobility: "Must not have resided in Croatia for more than 12 months in the 36 months prior to recruitment."
    },
    {
        ...
        secondments: ["Host: University of Aberdeen, UK", "Planned Secondments*: CIRCLE (Complex Intervention Research in Health and Care), Uppsala University, Sweden (M12-16) and PFMD (Patient-Focused Medicines Development), Belgium(M22-26)."],
